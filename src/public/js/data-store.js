...
const emptyData = () => ({ proveedores: [], tipos: [], gruposProductos: [], productos: [], metodosPago: [], stock: {}, reservedStock: {}, ventas: [], cajas: [], peluqueriaTiposPerro: [], peluqueriaServicios: [], peluqueriaTurnos: [], peluqueriaHorarios: [], ticketConfig: [], auditoria: [], usuarios: [] });
